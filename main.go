...
func init() {
	...
	utilruntime.Must(eventnotifierv1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:   "7cb57903.drhelius.io",
	})
	if err != nil {
	...
	if err = (&controllers.SlackNotificationReconciler{
		Client: mgr.GetClient(),
		Log:    ctrl.Log.WithName("controllers").WithName("SlackNotification"),
